.PHONY: platform serve writer analyst researcher analyzer mcp enterprise marketplace build test vet tidy clean docker dev
...
# Start the full demo stack (platform + writer + analyst) via Docker Compose
dev:
